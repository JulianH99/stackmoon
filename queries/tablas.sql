...
alter table productos
  ...
  add column agregado date not null default current_date,
  add column actualizado date not null default current_date;

alter table facturas
  add column activo boolean not null default true,
  add column agregado date  default current_date,
  add column actualizado date  default current_date;
